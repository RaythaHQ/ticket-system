...
public class FollowTicket
{
    ...
    public class Handler : IRequestHandler<Command, CommandResponseDto<ShortGuid>>
    {
        ...
        )
        {
            ...
            var existingFollow = ticket.Followers.FirstOrDefault(f => f.StaffAdminId == userId);
            ...
            var changeLog = new TicketChangeLogEntry
            {
                TicketId = request.TicketId,
                ActorStaffId = userId,
                Message = $"{user?.FullName ?? "Unknown"} started following this ticket",
            };
