...
public class GetTeamReport
{
    ...
    public class Handler : IRequestHandler<Query, QueryResponseDto<TeamReportDto>>
    {
        ...
        )
        {
            ...
            var openTickets = tickets.Count(t => t.Status == TicketStatus.OPEN || t.Status == TicketStatus.IN_PROGRESS);
            ...
            var unassignedTickets = tickets.Count(t => t.AssigneeId == null && t.Status != TicketStatus.CLOSED);
            ...
            var slaComplianceRate = slaTicketsWithResult > 0 ? (double)slaMetCount / slaTicketsWithResult * 100 : 100;
            ...
            // Member breakdown
            var teamMembers = await _db.TeamMemberships
                .AsNoTracking()
            ...
            {
                var memberTickets = tickets.Where(t => t.AssigneeId == member.StaffAdminId).ToList();
                ...
                memberMetrics.Add(new MemberMetricsDto
                {
            ...
            return new QueryResponseDto<TeamReportDto>(new TeamReportDto
            {
                TeamId = teamId,
                TeamName = team.Name,
