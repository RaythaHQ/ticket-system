...
{
    public static readonly IReadOnlyList<FilterAttributeDefinition> All =
        new List<FilterAttributeDefinition>
        {
            // Ticket Core
            new()
            {
                ...
                Label = "Ticket ID",
                Type = "numeric",
                Operators = OperatorDefinitions.NumericOperators,
            },
            new()
            {
                Field = "Title",
                Label = "Title",
                Type = "string",
                Operators = OperatorDefinitions.StringOperators,
            },
            new()
            {
                Field = "Description",
            ...
            // Status, Priority & Language
            new()
            {
                Field = "Status",
                Label = "Status",
                Type = "status",
                Operators = OperatorDefinitions.SelectionOperators,
            },
            new()
            {
                Field = "Priority",
                Label = "Priority",
                Type = "priority",
                Operators = OperatorDefinitions.PriorityOperators,
            },
            new()
            {
                Field = "Language",
            ...
            new()
            {
                ...
                Label = "Assignee",
                Type = "user",
                Operators = OperatorDefinitions.UserOperators,
            },
            new()
            {
            ...
            new()
            {
                ...
                Label = "Created At",
                Type = "date",
                Operators = OperatorDefinitions.DateOperators,
            },
            new()
            {
            ...
            new()
            {
                Field = "Contact.OrganizationAccount",
