    ...
    public class Validator : AbstractValidator<Command>
    {
        public Validator(IAppDbContext db)
        {
            ...
            RuleFor(x => x.AppointmentId)
                ...
                .WithMessage("Only active appointments can be cancelled.");
            ...
            RuleFor(x => x)
                ...
                .WithMessage(
                    "Cancelling within the minimum cancellation notice period requires a CancellationNoticeOverrideReason."
                );
        }
    }
    ...
    public class Handler : IRequestHandler<Command, CommandResponseDto<long>>
    {
        ...
        )
        {
            ...
            if (!appointment.StatusValue.IsActive)
                throw new BusinessException("Only active appointments can be cancelled.");
            ...
            var history = new AppointmentHistory
            {
                ...
                OverrideReason = request.CancellationReason,
