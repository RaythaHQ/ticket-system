...
namespace App.Infrastructure.Migrations
{
    ...
    [Migration("20260215203033_AddStaffBlockOutTimes")]
    partial class AddStaffBlockOutTimes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Domain.Entities.OrganizationSettings", b =>
                {
                    ...
                    b.Property<bool>("PauseSlaOnSnooze")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("App.Domain.Entities.StaffBlockOutTime", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("App.Domain.Entities.Ticket", b =>
                {
                    ...
                    b.Property<Guid?>("SnoozedById")
                        .HasColumnType("uuid");

                    b.Property<string>("SnoozedReason")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<DateTime?>("UnsnoozedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("App.Domain.Entities.WikiArticle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("App.Domain.Entities.StaffBlockOutTime", b =>
                {
                    ...
                    b.HasOne("App.Domain.Entities.SchedulerStaffMember", "StaffMember")
                        .WithMany("BlockOutTimes")
            ...
            modelBuilder.Entity("App.Domain.Entities.Ticket", b =>
                {
                    ...
                    b.HasOne("App.Domain.Entities.User", "SnoozedBy")
                        .WithMany()
                        .HasForeignKey("SnoozedById")
                        .OnDelete(DeleteBehavior.SetNull);
